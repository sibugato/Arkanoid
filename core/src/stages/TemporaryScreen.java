...
public class TemporaryScreen extends State {

    private ExtendViewport extendViewport;
    private Texture background  = new Texture("YouDiedScreen.jpg");
    InputController inputController = new InputController();
    SpriteBatch spriteBatch = new SpriteBatch();


    public TemporaryScreen(GameStateManager gsm) {
        super(gsm);
    ...
    public void render() {
        ...
        spriteBatch.begin();
        spriteBatch.draw(background,0,0,24,40);
        spriteBatch.end();
    }
